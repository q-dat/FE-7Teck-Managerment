...
import ModalCreateTabletPageAdmin from '../../components/admin/modalAdmin/TabletModal/CreateTablet.modal';
import ModalDeleteTabletPageAdmin from '../../components/admin/modalAdmin/TabletModal/DeleteTablet.modal';
import ModalEditTabletPageAdmin from '../../components/admin/modalAdmin/TabletModal/EditTablet.modal';
              ...
              tablets.map((tablet: ITablet, index: number) => (
                <Table.Row key={index}>
                  ...
                  <span className="leading-5">
                    ...
                    <span className="bg-black p-1 text-white dark:bg-white dark:text-black">
                      {tablet?.tablet_color}
                    </span>
                  </span>
