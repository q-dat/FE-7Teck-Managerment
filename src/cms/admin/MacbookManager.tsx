...
import ModalCreateMacbookPageAdmin from '../../components/admin/modalAdmin/MacbookModal/CreateMacbook.modal';
import ModalDeleteMacbookPageAdmin from '../../components/admin/modalAdmin/MacbookModal/DeleteMacbook.modal';
import ModalEditMacbookPageAdmin from '../../components/admin/modalAdmin/MacbookModal/EditMacbook.modal';
...
const MacbookManager: React.FC = () => {
  ...
  return (
    <div className="w-full pb-10 xl:pb-0">
      ...
      />
      <ModalCreateMacbookPageAdmin isOpen={isModalCreateOpen} onClose={closeModalCreateAdmin} />
