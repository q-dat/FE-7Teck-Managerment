...
export function InlinePriceEditor<T>({
    ...
    return (
      <div className="flex items-center justify-center gap-2">
        <Input
          ...
          className="w-[90px] rounded border bg-transparent px-0.5 py-1 focus:outline-none"
          onChange={e => {
  ...
  return (
    <span
      className="inline-block w-[90px] rounded-lg border border-red-700 bg-red-500 bg-opacity-20 px-0.5 py-1 font-semibold text-red-700 dark:border-red-900 dark:bg-black dark:text-white"
