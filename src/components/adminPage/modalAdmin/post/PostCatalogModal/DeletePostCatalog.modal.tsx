...
interface ModalDeletePostCatalogProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

const ModalDeletePostCatalogPageAdmin: React.FC<ModalDeletePostCatalogProps> = ({ isOpen, onClose, onConfirm }) => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="font-bold text-black dark:text-white">Bạn có chắc muốn xóa danh mục bài viết này?</p>

        <div className="w-full py-5 text-center text-gray-500 dark:text-gray-300">
          Sau khi nhấn <span className="font-bold text-primary">"Xác nhận"</span>, danh mục sẽ bị xoá khỏi hệ thống.
        </div>
...
export default ModalDeletePostCatalogPageAdmin;