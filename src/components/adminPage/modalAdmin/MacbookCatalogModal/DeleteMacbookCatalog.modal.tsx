...
const ModalDeleteMacbookCatalogPageAdmin: React.FC<ModalDeleteAdminProps> = ({ isOpen, onClose, onConfirm }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="">
          <p className="font-bold text-black dark:text-white">Bạn có chắc muốn xóa danh mục này?</p>
        </div>
...
export default ModalDeleteMacbookCatalogPageAdmin;
