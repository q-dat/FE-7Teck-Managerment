...
import SidebarGallery from '../../gallery/SidebarGallery';

const NavbarGallery: React.FC<{ Title_NavbarGallery: string }> = ({ Title_NavbarGallery }) => {
  ...
  return (
    <div className="flex flex-col px-2 pb-6 xl:hidden xl:px-0">
      <div className="mb-6 flex items-center justify-between">
        ...
        {/* Title_NavbarMobile */}
        <div>
          <p className="font-semibold text-black dark:text-white">{Title_NavbarGallery}</p>
        </div>
        {/* Sidebar Right */}
        <div className="z-50">
          <Drawer
