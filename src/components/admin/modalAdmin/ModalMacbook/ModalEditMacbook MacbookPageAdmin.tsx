...
const ModalEditMacbookPageAdmin: React.FC<ModalEditPageAdminProps> = ({ isOpen, onClose, macbookId }) => {
        ...
        >
          ...
          <div className="flex w-full flex-row items-start justify-between gap-10">
            <div className="flex w-full flex-col items-start justify-center">
              ...
              <LabelForm title={'Giá'} />
              <InputModal type="number" {...register('macbook_price')} placeholder="Giá" />
              <LabelForm title={'Giá giảm'} />
              <InputModal type="number" {...register('macbook_sale')} placeholder="Nhập giá giảm" />
              <LabelForm title={'Màu sắc'} />
              <InputModal type="text" {...register('macbook_color')} placeholder="Nhập màu" />
            </div>
            <div className="flex w-full flex-col items-start justify-center">
              <LabelForm title={'Tình trạng'} />
              <InputModal type="text" {...register('macbook_status')} placeholder="Tình trạng" />
