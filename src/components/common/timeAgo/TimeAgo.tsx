...
const TimeAgo: React.FC<TimeAgoProps> = ({ date }) => {
  ...
  const className = isRecent ? 'rounded text-green-900 w-full bg-green-100 inline-block dark:text-green-500  dark:bg-transparent' : 'text-gray-700 dark:text-white';
